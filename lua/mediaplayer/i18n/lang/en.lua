...
MediaPlayer.i18n.RegisterLanguage("en", {
	...
	-- Mimick tool
	["mp.tool.mimick.name"]              = "Mimick Media Player",
	["mp.tool.mimick.desc"]              = "Mirror another media player's video output onto a second screen.",
	["mp.tool.mimick.usage"]             = "Left click: copy source. Right click: paste onto target(s). Reload (R): remove mimick.",
	["mp.tool.mimick.help_copy"]         = "Left click a media player to copy it as the video source.",
	["mp.tool.mimick.help_paste"]        = "Right click other media players to paste — they will mirror the source. You can paste onto multiple screens.",
	["mp.tool.mimick.help_remove"]       = "Press Reload (R) on a mimick player to remove it and restore the original.",
	["mp.tool.mimick.source_copied"]     = "Source copied! Right click other media players to paste.",
	["mp.tool.mimick.pasted"]            = "Mimick applied! This screen now mirrors the source.",
	["mp.tool.mimick.removed"]           = "Mimick removed. Entity restored to normal.",
	["mp.tool.mimick.undo"]              = "Mimick Media Player",
	["mp.tool.mimick.error_spatial"]     = "Cannot mimick a spatial media player.",
	["mp.tool.mimick.error_same"]        = "Source and target cannot be the same entity.",
	["mp.tool.mimick.error_no_source"]   = "No source copied yet. Left click a media player first.",
	["mp.tool.mimick.error_source_gone"] = "The copied source no longer exists. Left click a new source.",
	["mp.tool.mimick.error_mimick_source"] = "Cannot copy from a mimick player. Copy from the original source instead.",
	["mp.tool.mimick.error_already_linked"] = "This entity is already mimicking that source.",
	["mp.tool.mimick.error_not_mimick"]  = "This entity is not a mimick player.",
	["mp.tool.mimick.error_has_content"] = "Cannot mimick a media player that is currently serving its own content. Stop or clear its media first.",
})